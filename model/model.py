...
class LayerNorm(nn.Cell):
    ...
    def __init__(self,
                 in_channels=None, epsilon=1e-5):
        super(LayerNorm, self).__init__()
        self.layer_norm = nn.LayerNorm((in_channels,), epsilon=epsilon)
        self.cast = P.Cast()
...
class FeedForward(nn.Cell):
    ...
    def __init__(self,
        ...
        self.layernorm = LayerNorm(in_channels=in_channels, epsilon=layer_norm_epsilon)
...
class MaskedMultiHeadAttention(nn.Cell):
    ...
    def __init__(self,
        ...
        self.layer_norm = LayerNorm(in_channels=d_model, epsilon=layer_norm_epsilon)
...
class GPT2Model(nn.Cell):
    ...
    def __init__(self,
        ...
        self.layer_norm = LayerNorm(in_channels=self.d_model, epsilon=self.config.layer_norm_epsilon)
